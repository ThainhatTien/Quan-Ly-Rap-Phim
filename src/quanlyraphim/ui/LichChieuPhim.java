 ...
 * @author Admin
 */
public class LichChieuPhim extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblLichChieu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Lịch Chiếu", "Mã Phim", "Mã Phòng", "Giờ Chiếu", "Ngày Chiếu"
            }
        ));
        ...
        txtMaLichChieu.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        txtGioChieu.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtMaLichChieu, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblMaLichChieu))
                        .addGap(20, 20, 20)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jDangXuatMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jDangXuatMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_jDangXuatMouseEntered
    ...
    public boolean validateForm() {
        if (txtMaLichChieu.getText().isEmpty() || txtMaPhim.getText().isEmpty() || txtMaPhong.getText().isEmpty()) {
            return false;
        }
        return true;
    }
...
//        } else {
        String id = txtMaLichChieu.getText();
...
//        }
    ...
    void fillTable() {
        ...
        model.setRowCount(0);
        try {
            List<LichChieu> list = dao.selectAll();
...
//        tabs.setSelectedIndex(0);
    ...
    void updateStatus() {
        if (Auth.isManager()) {
            ...
            //form state
            txtMaLichChieu.setEditable(!edit);
...
//        btnLast.setEnabled(edit && !last);
    ...
    void setForm(LichChieu lc
        ...
        txtMaPhim.setText(lc.getMaPhim());
    ...
    LichChieu getForm() {
        ...
        lc.setMaPhim(txtMaPhim.getText());
